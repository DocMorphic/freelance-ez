...
export default function FooterStandard({ config, company }: FooterStandardProps) {
      ...
      <div className={styles.container}>
        <div className={styles.footerTop}>
          ...
          <div className={styles.footerBrand}>
            <LogoMark companyName={company.name} small />
            {company.tagline && (
              <div className={styles.brandTagline}>{company.tagline}</div>
            )}
            {company.description && (
...
/* Inline SVG social icons — keeps lucide-react as the only icon dep */
